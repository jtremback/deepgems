...
interface CubicBondingCurveInterface extends ethers.utils.Interface {
  functions: {
...
export class CubicBondingCurve extends Contract {
  ...
  interface: CubicBondingCurveInterface;
