...
interface LinearBondingCurveInterface extends ethers.utils.Interface {
  functions: {
...
export class LinearBondingCurve extends Contract {
  ...
  interface: LinearBondingCurveInterface;
